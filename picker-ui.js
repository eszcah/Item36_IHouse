...
(function (root, factory) {
    ...
    PickerUI.prototype.getItemElem = function(item, settings) {
        ...
        if (item.image || this.options.getItemImageUrl) {
            ...
            itemContent = $('<iframe src="' + (this.options.getItemImageUrl ? this.options.getItemImageUrl(item,settings) : item.image) + '" width="280" height="90" frameborder="0" allowtransparency="true" allow="encrypted-media"></iframe>' + '<span>' + itemName + '</span>');
        }
        else {
